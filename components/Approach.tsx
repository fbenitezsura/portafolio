    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        <Card
          ...
          des="Colaboraremos para trazar los objetivos de su sitio web, el público objetivo, 
          y funcionalidades clave. Discutiremos cosas como la estructura del sitio, 
          requisitos de navegación y contenido."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          des="Una vez que estamos de acuerdo en el plan, introduzco mi lista de reproducción lofi y me sumerjo en
          codificación. Desde bocetos iniciales hasta código pulido, los mantengo actualizados
